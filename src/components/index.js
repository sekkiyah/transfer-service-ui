...
export { default as OutboundTransferAdvancedForm } from './outbound/TransferAdvancedForm';
...
export { default as OutboundTemplateAdvancedForm } from './outbound/TemplateAdvancedForm';
