...
const TemplateAdvancedForm = ({ newTemplate, setNewTemplate }) => {
        ...
        <Accordion.Body className='pb-0'>
          <Row className='mb-3'>
            <Form.Group as={Col} sm='4'>
              ...
              <Form.Control
                type='number'
                value={newTemplate.timeout || ''}
                placeholder='Seconds'
                onChange={e => setNewTemplate({ ...newTemplate, timeout: e.target.value })}
              />
            ...
            <Form.Group as={Col} sm='4'>
              ...
              <Form.Control
                type='number'
                value={newTemplate.maxRetries || ''}
                placeholder='Count'
                onChange={e => setNewTemplate({ ...newTemplate, maxRetries: e.target.value })}
              />
            ...
            <Form.Group as={Col} sm='4'>
              ...
              <Form.Control
                type='number'
                value={newTemplate.reconnectInterval || ''}
                placeholder='Seconds'
                onChange={e => setNewTemplate({ ...newTemplate, reconnectInterval: e.target.value })}
              />
          ...
          <Row className='mb-3'>
            <Form.Group as={Col} sm='6'>
              ...
              <Form.Control
                type='text'
                value={newTemplate.sshKexAlgorithm || ''}
                placeholder='Example: diffie-hellman-group14-sha1'
                onChange={e => setNewTemplate({ ...newTemplate, sshKexAlgorithm: e.target.value })}
              />
            ...
            <Form.Group as={Col} sm='6'>
              ...
              <Form.Control
                type='text'
                value={newTemplate.sshHostkeyAlgorithm || ''}
                placeholder='Example: ssh-dss'
                onChange={e => setNewTemplate({ ...newTemplate, sshHostkeyAlgorithm: e.target.value })}
              />
              <Form.Text>Usually left blank</Form.Text>
            </Form.Group>
          </Row>
...
export default TemplateAdvancedForm;
